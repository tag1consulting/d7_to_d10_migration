...
Execute these commands to get a fully migrated Drupal 10 site. It will be available at https://migration-drupal10.ddev.site/
...
ddev composer si
ddev drush migrate:import --tag=tag1_content
ddev launch
ddev drush uli
```
